...
https://stock.adobe.com/images/supreme-pizza-lifted-slice-3/27579652
https://as1.ftcdn.net/jpg/00/27/57/96/1000_F_27579652_tM7V4fZBBw8RLmZo0Bi8WhtO2EosTRFD.jpg
__Add new diagram here.__
 
Let’s create a Pizza class. Here are the basic requirements:
* It must declare its size
* It can have additional toppings.

## Constructor Implementation
My initial design declares the size and several toppings, but other than a `toString()` method, it doesn’t have any additional behaviors:
```java
import java.util.*;
...
* A constructor with four boolean parameters/arguments is confusing. It’s not obvious which boolean argument value aligns with which parameter. Most IDEs will add the field name, which is okay, but that also violates encapsulation to some degree.
