...
Blogs that tended to lean toward Software Engineering rather than Computer Science.

## Abstraction
Abstraction is a core software engineering concept, and more challenging to describe that I thought. It's challenging to be concrete about abstraction
...
## Miscellaneous
* [Bumper Sticker Computer Science and Software Engineering](https://jhumelsine.github.io/2023/12/15/bumper-sticker-computer-science-software-engineering.html) - This is blog that I enjoy the most.
* [My Design Process](https://jhumelsine.github.io/2024/05/28/design-process.html)

# Design Patterns
Design Patterns changed how I approach software. Most of the blog entries have been dedicated to design patterns.

## Design Pattern Principles
These are among my earliest blogs where I set the foundations for design patterns.

* [Are you a cook or a chef?](https://jhumelsine.github.io/2023/08/21/knock-knock-whos-there.html)
