...
In addition to platforms, such as ChatGPT, also consider **Interactive AI Notebooks** such as those offered by [Gemini NotebookLM (formerly Google NotebookLM)](https://notebooklm.google.com/).
They allow you to configure a notebook with specific content, and the AI will remain focused upon that content.
Gemini's platform provides several preconfigured artifact generators, including an audio podcast, of the configured content.
...
It hosts thousands of books and videos including titles from publishers other than O'Reilly.
...
* There's at least one more option coming up shortly within the [ACM Digital Library](#acm-digital-library) section.
...
That structure is still available after you graduate.
Better yet, you can take almost any course you want, possibly for free, and not worry about the grade.
...
I learned additional algorithmic techniques, such as: [Greedy Algorithms](https://en.wikipedia.org/wiki/Greedy_algorithm) and [Dynamic Programming](https://en.wikipedia.org/wiki/Dynamic_programming).
I learned technology that arose after in the decades after I had graduated, such as: Python, Computer Networks, Android and Cloud Computing.
...
The new Coursera model provided more flexibility.
...
However, some platforms may have a no cost audit feature, which allows you to watch the online content for free.
...
* Computer Science and Theory:
    ...
    * [Computation as a Universal and Fundamental Concept](https://ergo.org/courses/computation-as-a-universal-and-fundamental-concept) - Tim Roughgarden highlights  fundamental concepts of computation, its history, evolution, implications and where it might go from here.
...
* General Software Engineering:
    * [O'Reilly Conference Playlists](https://www.youtube.com/@oreilly/playlists) - This is part of O'Reilly.
...
Others are inspirational or promotional.
Learning to distinguish substance from hype is part of becoming a senior engineer.
...
Listening to podcast hosts in your ears creates parasocial connection with them.
...
I have found that these lists tend to have little or no unwanted content inserted in these feeds.
...
* [Twitter/X Software Engineering](https://x.com/i/lists/888744335466008576) - Curated by [Neil Whitlow](https://x.com/NeilWhitlow)
