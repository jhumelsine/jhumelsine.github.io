...
In my previous blog (TBD -https://jhumelsine.github.io/2026/06/05/ai-and-developer.html), I discussed how Generative AI is changing software development and the role of software engineers.
...
Developers tend to fall into two camps:
* Makers: Those who care about delivering features to the customer/user as quickly as possible.
* Menders: Those who care about the clarity and structure of the code.

Both are important.
Generative AI will allow makers to deliver more quickly, but this should not come at the expense of the clarity and structure of the code.

# Prompting vs Agentic Coding
Most people are familiar with prompting. **REWORD THIS**
