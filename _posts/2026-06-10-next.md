...
* Prototype implementations that demonstrate features to customers and can be used as working models for the development team.
...
* Tools to aid you in your day-to-day work. These are probably a subset of small well scoped and bounded problems.

## Agents
Prompting AI platforms, such as ChatGPT, are agents too.

Agents respond to an input stimulus.
Agents create output artifacts.
Agents may interact with one another directly or indirectly via their inputs and outputs.
Agents may have a specific set of skills and constraints that specialize or focus what they do.

Their inputs and outputs tend to be text.
They tend to interact with a human.
Their skills and constraints tend to be encapsulated from the person interacting with them.
Each session will have its own context based upon prompts.
