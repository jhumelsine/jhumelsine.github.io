...
The toil of implementation by humans is decreasing through AI.
The architecture, decomposition, boundaries, communication and judgment by humans is increasing, since the reduction of implementation toil accelerates the process.
...
Prompts provide context, which will be retained with the sessions, baring Context Window (TBD) limitations until the end of the session.
...
I have used this technique to generate code, but it tends to be very small well scoped and bounded requests.
...
**PROVIDE EXAMPLES: prototypes, small problems and tools**
