...
I first heard the Maker (Adding) vs Mender (Fixing) distinction in M. Scott Ford's [Makers vs Menders](https://www.youtube.com/watch?v=YW0BpCThjuM) presentation.
...
* Code generation that's well defined and scoped. For example, adding `equals()` and `hashCode()`.
