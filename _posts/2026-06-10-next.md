...
I just don't know what that change will be.
I doubt that anyone knows how AI will shape software engineering, even those who are using it practically and professionally.
All I can do is state my impressions for whatever it's worth.
_Caveat Emptor._

Given that my impressions are based upon external observations of a constantly changing field, I think the only way I can make progress and publish this is to do the following:
* List my impressions as they currently stand.
* Structure this blog entry as an anthology of related themes rather than one story. Treat each section as its own vinette much like the Jerry Lewis movie: [The Bellboy](https://en.wikipedia.org/wiki/The_Bellboy).
* Revisit this blog entry and update it as my impressions change, there are new advancements and discoveries, and there are new references to add.
...
Scott aligned developers along a Makers/Menders attribute spectrum and then added a perpendicular attribute spectrum of Hacker (Speed) vs Crafter (Quality).
The two attribute spectrums create 2x2 matrix defining four different types of developers: 
...
# Agents
Agents are entities that do tasks on your behalf, often at your direction:
...
Can we trust code created by humans?
...
Though we had used testing and other processes to confirm the software, much of the confidence we had in our softare depended upon on the trust we had with experienced developers.
