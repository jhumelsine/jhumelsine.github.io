...
I want to continue that theme, but this time focus specifically on Agentic AI and Agentic Coding.
...
Both are important.
Generative AI will accelerate makers, but this should not come at the expense of the clarity and structure of the code desired by menders.
...
They interact with it almost as if in a conversation.
My previous [LLM/GenAI](https://jhumelsine.github.io/table-of-contents#ai-and-emerging-topics) blog entries featured this type of interaction.

Prompting is synchronous.
Ask AI a question or give it a task, and it responds.
It will wait indefinitely until you continue.

The AI tends to be a blank slate until prompts are provided.
Context must be provided in the prompts.
The context will be retained with the sessions, baring Context Window (TBD) limitations until the end of the session.

Some AI platforms, such as ChatGPT, will retain some context after the session is over.
It's mostly building a profile of the person interacting with it rather than details about any specific session.
It's sort of like a dossier.
I saw mine once when ChatGPT warned me that I was running out of space, and it gave me the option to do some clean up.
Some aspects were accurate, but it made a lot of incorrect assumptions about me based upon my chats.
