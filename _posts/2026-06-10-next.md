...
* Makers (Adding): Those who care about delivering features to the customer/user as quickly as possible.
* Menders (Correcting): Those who care about the clarity and structure of the code.
...
The main difference is that you request code rather than a report, table, essay, etc.
...
Vibe Coding feels more like a one-and-done task.
...
The agents would not only collaborate, but they could enforce a system of checks and balances to help ensure confidence in the code that's genrated.

We might also want to limit or restrict direct agent interaction. Instead agents might interaict via artifacts flowing between them:
* requirements
* tests
* implementations
* logs
...
These are the same questions we have had with human softare developers as individual contributors.
