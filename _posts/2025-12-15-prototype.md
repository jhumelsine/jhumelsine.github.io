...
I chose an abstract class rather than an interface, because I want to store some information in `Shape` along with some implementation. It's easier to do that when it's an abstract class.
