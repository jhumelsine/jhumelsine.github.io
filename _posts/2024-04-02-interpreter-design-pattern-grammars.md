...
Sometimes we never learned formal grammar rules. For example, all English speakers would choose _big blue marble_ rather than _blue big marble_ in a phrase. If asked why, they would probably say that the first one sounds better.
https://commons.wikimedia.org/wiki/File:Adjective_Order.png
https://upload.wikimedia.org/wikipedia/commons/e/e3/Adjective_Order.png?20120322054144
...
https://commons.wikimedia.org/wiki/File:Delete_statement.gif
https://upload.wikimedia.org/wikipedia/commons/e/e9/Delete_statement.gif?20170424062623 
https://commons.wikimedia.org/wiki/File:Rail_Tracks_map_JR-E_Ikebukuro_Station.svg
https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/Rail_Tracks_map_JR-E_Ikebukuro_Station.svg/1200px-Rail_Tracks_map_JR-E_Ikebukuro_Station.svg.png 
...
The grammars for General-Purpose Languages (GPL) are surprisingly small considering that every possible program that can be written can be generated uniquely from the root. Here are GPL grammar rules:
...
```java
+(3, *(2, 6), 5)    // Which should evaluate to 3 + 12 + 5 => 20.
```
