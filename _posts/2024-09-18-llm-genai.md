...
Did you ever make a copy of a copy on a copier and then copy that copy, etc.? Each new copy derives from the original, but imperfections quickly amass. Any sudges on the copier surface and other imperfections will propagate. Eventually the last link the chain will have degraded so much that its similarities to the original will be nil.
