...
LLMs only work if they are built from large amounts of training data, which is obtained from the internet. While content on the internet is accessible, that doesn't mean that it isn't also protected as intellectual property.
