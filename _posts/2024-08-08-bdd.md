...
* Boundary behaviors tend to be easy and obvious to implement. Since you're not trying to solve the whole problem in its generic form, there's not as much staring at _blank screen_ and wondering where to start.
