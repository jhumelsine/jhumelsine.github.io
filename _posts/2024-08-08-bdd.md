...
* `bookOrderEventHander_ShipsBook_WhenReceivingBookOrderEvent()`
...
__Verify__ cofirms interaction with other software elements. It could be implementation dependent.
