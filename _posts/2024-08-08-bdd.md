...
BDD test names summarize the behavior specification. The test name is often declared as a method name. They tend to be longer than traditional method names. There is no test name guidelines to the best of my knowledge. Clarity and consistency are what's important.
