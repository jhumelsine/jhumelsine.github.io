...
* Considering the edge and boundary cases gives me more time to think about the problem as a whole. I have more time to think and consider a good overall solution.

At first, the implementation will look like a patchy quilt that  handles the edge and boundary behaviors separately. But recall that refactoring is part of the TDD process. Similarities will emerge in the implementation. Refactor the code to consolidate those similarities as they emerge.
