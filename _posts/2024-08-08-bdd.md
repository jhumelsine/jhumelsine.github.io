...
At first, the implemenation will look like a patchy quilt that  handles the edge and boundary behaviors separately. But recall that refactoring is part of the TDD process. Similarties will emerge in the implementation. Refactor the code to consolidate those similarities as they emerge.
