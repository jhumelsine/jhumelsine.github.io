...
I am a computer science sophomore who wishes to know more about your company. 

I would like to have a conversation with you where you tell me about your company. I would like for you to initiate the conversation. I will answer your questions and ask you questions. Tell me about your company. 

Tell me how I can learn more about software engineering and do meaningful work. Ask me questions. I will ask you questions. 

Continue the conversation until I tell you to stop and summarize it. Generate a set of facts about the company after the summary. The set of facts should be the fundamental facts that could undermine the veracity of the output if any of them are incorrect. I want to be able to verify them independently. 

You are a recruiter for IBM.  

•	This may not be the best prompt, but it can easily be adjusted by you. The LLM may not know anything about the company, but at a minimum, it gives you a chance to practice for an interview. I tried the prompt again with two of my previous companies, rather than IBM, and the conversations were relevant to the work done there.  FWIW, I made up the above prompt on the fly. It was a variant of one I used recently in my blog: https://jhumelsine.github.io/2024/09/25/prompt-engineering-patterns1.html#career-councilor
•	If you make a good impression on the recruiter, this will lead to a technical interview. The industry still doesn't know how to conduct a good technical interview, and I was part of that dismal practice during my career when I was an interviewer as well. However, internship interviews tend to be more forgiving. When I interviewed interns, I was looking for someone with passion. I also knew that even if we made a mistake in hiring the wrong kid, they would only be with us for about three months. This wasn't as much of an investment as it was with a permanent hire.
...
•	The above script is a variant on: https://jhumelsine.github.io/2024/10/18/prompt-engineering-patterns2.html#computer-science-ta-tutor
•	Sometimes, an interviewer's recommendation is based upon whether they liked the interviewee. How would it feel to spend 8 hours each day with this person in the office? Knowledge gaps can be filled. Someone being a jerk usually can't be corrected. So don't be an arrogant jerk in an interview. LOL.
•	Leverage the internet for your internship job search. For example, there may not be too many recruiters from MD at a PSU job fair. Google has a Job search feature such that once you get the search as you want it, such as software engineering internships in Maryland. You can set up an alert so that it will send you new emails when it finds jobs that match that job search query. I have a brief description of how to do this at: https://jhumelsine.github.io/2024/08/11/jobsearch.html#automate-your-job-search 

Interviewing is a lot like speed dating. You may have to do a lot of it, but you keep in mind that you only need to find one match.
Some companies use internships as a three-month long interview. They may make you an offer when you graduate. My last company used to do that extensively. My wife’s company never did it. That could be a question to ask in the interview.
You will be asked if you have any questions. Have a few. Any questions about the company specifically would be good. If not, have a few general questions too. Here are a few examples, but chose ones that feel the best to you. …
