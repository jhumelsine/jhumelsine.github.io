...
For the most part, process in obtaining a Computer Science degree is basically being assigned a scoped and well-defined problem assignment, completing it, and then handing it in the following week.
Sometimes you are organized in teams, but for the most part, you tend the be the only person working on your implementation.
...
It hosts thousands of books and videos; however, it is a subscription service.
Here are a few subsription options:
* If you're lucky, your employers will provide a subscription. My last employer provided a subscription to all developers for several years, but they have since canceled it.
* Subscribe yourself from their various [Plans](https://www.oreilly.com/online-learning/pricing.html); however, it's not inexpensive. You can try a [Free 10-Day Trial](https://www.oreilly.com/start-trial/?type=individual) to see if you like it.
* Join the [Association for Computing Machinery(https://www.acm.org/) (ACM) and sign up for their [Skills Bundle Add-On](https://learning.acm.org/skills-bundle), which includes a partial O'Reilly subscription plan along with a [Skillsoft Percipio ](https://www.skillsoft.com/) subscription. The ACM O'Reilly plan isn't the entire O'Reilly plan, but it includes the entire O'Reilly 60,000 book and video collection plus Skillsoft for about half the price of an full blow O'Reilly subscription. The ACM and O'Reilly relationship has been ... fluid. O'Reilly used to be included with ACM membership only, but with restricted access. Then it transitioned to full access. Then it transititioned to limited book/video access. Then it disappeared without any access. And now the current availability is back to book/video, but with the addition of the Skills Bundle Add-On. I'm sure it will change again in a few years.
