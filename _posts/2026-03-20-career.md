...
## Principles, Patterns, Practices, Procedures, Policy and Process
The **P**s probably aren't covered in most Computer Science programs.
These categories don't have well defined boundaries, and they sometimes bleed into one another.
Some concepts could fit into several categories.

I'll provide a brief summary with an example or two for each.

### Principles
Principles tend to be foundation concepts, but unlike foundation concepts in mathematics or the physical sciences, softare concepts tend to be opinionated.
They drift in and out of favor.
This can occur due to new techology or new ways of thinking about problems.

In 1968, Dijsktra basically removed the `goto` statement from higher programming languages when the **Communications of the ACM** published his Letter to the Editor titled: [Go To Statement Considered Harmful](https://dl.acm.org/doi/epdf/10.1145/362929.362947), which lead to [Structured Programming](https://en.wikipedia.org/wiki/Structured_programming).

The [SOLID Design Principles](https://en.wikipedia.org/wiki/SOLID) is another.

Since there's no proof for these opinionated principles, their acceptance is mostly based upon experience.
If we feel that they help us, we tend to believe in them.
If we feel that they impede us, we tend to disregard them.

Principles tend to fall into a _theory_ category.

### Patterns
Patterns are common approaches to reoccuring problems.
Patterns aren't complete solutions.
Patterns provide a roadmap toward designing your own solution.

I've devoted most of my blog entries to [Software Design Patterns](https://jhumelsine.github.io/table-of-contents#design-patterns-and-architecture) and their [Foundations](https://jhumelsine.github.io/table-of-contents#design-pattern-foundations).
Software Design Patterns tend to be associated with Object-Oriented Paradigms, but Patterns in general are not limited to OOP.
Most paradigms have patterns.

Patterns tend to feature the application of Principles.

### Practices
Practices are the Process, Policy and Procedures we follow as an organization to write software.
