...
Principles and Patterns deal with the architecture, design and implementation of programs. Topics include:
* SOLID Design Principles
* Modern Softare Engineering Design Principles
...
### Practices, Procedures, Policy and Processes
Practices, Procedures, Policy and Processes deal with the management of teams building production quality software. Topics include:
* Waterfall
* Agile
* Event Storming
* Pair-Programming
