...
For the most part, a Computer Science assignment is basically a scoped and well-defined problem to be completed and handed in the following week.
...
These can be how-to videos that allow you follow along.

Some videos are more educational.

Any new software engineer should consider the [Modern Software Engineering Channel](https://www.youtube.com/@ModernSoftwareEngineeringYT).
