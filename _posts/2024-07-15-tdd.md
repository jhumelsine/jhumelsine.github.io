...
I can’t tell you how many times I heard stand-up reports like this:
...
Previous automated testing experiences weren't fruitful. Here are some common ones, which I may go into more detail with these in a future blog:
...
3.	__Refactor.__ Clean up the code. This is the _Make it right_ phase. Remove hard-coded return values. Remove the _faking it_ part. Make it more general. You have the confidence to do this, because you have passing test cases, which will alert you if you break something while refactoring. 
...
A complete __1-2-3__ cycle is often called the ___Red-Green-Blue___ TDD cycle. Red for the failing test. Green for the passing test. Blue for refactoring. Step 4 repeats the ___Red-Green-Blue___ cycle.
...
Period. The code is always working. If anything fails, it vanishes, and you're back to your previous passing green state. You're always in a known state, but it’s quite Draconian in returning there. If a test fails, then poof, all non-committed work vanishes.
