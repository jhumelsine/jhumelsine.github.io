...
# Summary
I’m going to wrap it up here, but there’s more to come. I’ll continue the TDD themes with a true story (TBD), how to determine what to test and some of the benefits (TBD) of TDD and possibly more. __Spoiler Alert:__ Testing isn’t necessarily the most important benefit of TDD.

I'll also provide a blog (TBD) to resolve some of the conflicts between [My Personal Process](https://jhumelsine.github.io/2024/05/28/design-process.html) and TDD.
