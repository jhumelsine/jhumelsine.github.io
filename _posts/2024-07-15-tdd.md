...
2.	__Make the failing test case pass.__ Hard code a passing solution, even if it doesn’t implement the general case. This is the _Make it work_ phase. Kent Beck refers to this as: [_Fake it until you make it._](https://wiki.c2.com/?FakeItUntilYouMakeIt) This made no sense to me when I first read it. Shouldn’t we implement the solution?
