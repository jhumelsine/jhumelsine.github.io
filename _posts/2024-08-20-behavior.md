...
I’ve also used the term __Observable Behavior__, which for me is behavior defined in the contract (future blog TBD). Observable behavior defines __what__ the [Software Under Test](https://en.wikipedia.org/wiki/System_under_test) (SUT) does without indicating __how__ it does it.
